  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container d-flex flex-column align-items-center">
        <h2 data-aos="fade-up" data-aos-delay="100">PLAN & GO!</h2>
        <p data-aos="fade-up" data-aos-delay="200">let's us start your journey</p>
    ...
    <section id="stats" class="stats section light-background">
        <div id="app" class="d-flex justify-content-center align-items-center vh-10" data-aos="fade-up"
            data-aos-delay="100">
            <div class="bg-white p-4 rounded shadow-lg w-100" style="max-width: 500px;">
                <h2 class="text-center mb-4">Find your Schedule!</h2>
...
<!-- Tampilkan card HANYA jika ada hasil -->
<section id="services" class="services section">
        @if (!empty($schedules) && count($schedules) > 0)
                <div class="container section-title" data-aos="fade-up">
                    <h2>travel.com</h2>
                    <p>Tickets available for you<br></p>
                </div>
